...
SUBSCRIPTION_KEY = os.getenv("SUBSCRIPTION_KEY")  # Correct environment variable name
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY")  # Correct environment variable name
...
def get_redis_client():
    try:
        client = Redis.StrictRedis.from_url(
            UPSTASH_REDIS_REST_URL, decode_responses=True, socket_timeout=300
        )
        return client
